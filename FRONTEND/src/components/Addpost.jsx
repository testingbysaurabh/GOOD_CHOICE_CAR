                ...
                <div className="grid grid-cols-3 md:grid-cols-6 gap-3 mt-3">
                  {previews.map((img, idx) => (
                    ...
                    >
                      <img
                        src={img.src}
                        className={`w-full h-24 object-cover ${idx === 0 ? "ring-2 ring-blue-500" : ""
                          }`}
                        alt={`preview-${idx}`}
                      />
...
function Input({ label, name, disabled, value, onChange, type = "text", error }) {
  return (
    <label className="text-sm block">
      ...
      <input
        ...
        value={value ?? ""}
        onChange={onChange}
        className={`w-full border px-3 py-2 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 ${error ? "border-red-500" : "border-slate-200"
          }`}
      />
